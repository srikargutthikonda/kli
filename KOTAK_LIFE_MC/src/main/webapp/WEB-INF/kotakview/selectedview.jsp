...
<body>
	...
	<ul id="navigation ">
		...
		<li><a href="makerHome"> <span class="menu-text ">Maker
					Verification</span>
		</a></li>

		<li><a href="selectedview" class="active"> <span
	...
	<div id="widget-inner" class="mt-sm pd-sm" style="overflow: auto;">
		...
		<div class="form-box" style="overflow: auto;">
			<form action="getSeletedValue" method="GET">
 ...
 --%>
				...
				<div class="form-button mt-md">
					<div class="form-button-1 pull-left">
						<button type="button" id="deleteSeleted"
							class="btn btn-custom btn-sm btn-none mr-xs">
