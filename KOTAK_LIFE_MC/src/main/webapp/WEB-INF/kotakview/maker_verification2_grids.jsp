...
<body>
	...
	<div id="widget-inner" class="mt-sm pd-sm" style="overflow: auto;">
			<form action="saveData" name="inputForm" id="inputForm"
								method="post">
		<table class="maker_main_table">
			<tr id="widget-inner" class="mt-sm pd-sm">
				<td style="width: 15%;">
                           	...
                           	<select name="Select" id="selectedRecord"
                           	 ...
                           	 --%>
                                    ...
                                    ${droplist.JOINT_LIFEASSURED_ID} )</option> --%>
										...
										<c:when
											test="${droplist.LIFEASSURED_ID == droplist.PROPOSED_ID}">
						...
						<div class="formDiv">
										...
										<tbody>
											...
											<tr>
												<td><input class="form-control" name="FIRSTNAME"
													value='${dgData.FIRSTNAME}' id="firstname" type="text"></td>
												<td><input class="form-control" name="MIDDLENAME"
													value='${dgData.MIDDLENAME}' id="middilename" type="text"></td>
												<td><input class="form-control" name="LASTNAME"
													value='${dgData.LASTNAME}' id="lastname" ="Enter the Father
													Name" type="text"></td>
												<td><input class="form-control" name="FATHER_NAME"
			                           ...
			                           <div class="input-group mt-xs">
			                           	<input class="form-control" name="dob"
			                           		="Select the Date" type="text" id="dob">
													...
													name="MOTHER_NAME" value='${dgData.MOTHER_NAME}'
													id="mothername" ="Enter the City" type="text">

												</td>
												<td><input class="form-control" name="DOB1"
													value='${dgData.DOB1}' id="dob" type="text"></td>
											</tr>
											<tr>
												<td><input class="form-control" readonly="readonly"
													name="GENDER_FLAG" value='${dgData.GENDER_FLAG}'
													id="gender" type="text"></td>
												<td><input class="form-control" name="PAN"
													value='${dgData.PAN}' id="pan" type="text"></td>
												<td><input class="form-control" name="PASSPORT"
								...
								<td>
									<div class="form-group  pull-left ml-sm mt-sm">
										...
										<div class="input-group mt-xs">
											<input class="form-control" name="VOTERID"
												value='${dgData.VOTERID}' id="voterid" type="text">
										</div>
									</div>
								</td>
								-->
												<td><input class="form-control" name="AADHAR"
													value='${dgData.AADHAR}' id="adharnumber" type="text">

												</td>
												<td><input class="form-control" name="DRIVING_LICN_NO"
													value='${dgData.DRIVING_LICN_NO}' id="dlicence" type="text"></td>
												<td><input class="form-control" name="RATIONCARD_NO"
													value='${dgData.RATIONCARD_NO}' id="rationnumber" ="Enter
													the City" type="text"></td>
											</tr>
											<tr>
												<td><input class="form-control" name="OFFICE_ADDRESS"
													value='${dgData.OFFICE_ADDRESS}' id="officeaddrres"
													type="text"></td>
												<td><input class="form-control" name="OFFICE_CITY"
													value='${dgData.OFFICE_CITY}' id="officecity" type="text"></td>
												<td><input class="form-control" name="OFFICE_PIN"
													value='${dgData.OFFICE_PIN}' id="officepincode" type="text"></td>
												<td><input class="form-control" name="OFFICE_STATE"
													value='${dgData.OFFICE_STATE}' id="officestate" ="Enter the
													City" type="text"></td>
												<td><input class="form-control" name="OFFICE_PHONE"
													value='${dgData.OFFICE_PHONE}' id="officecontact"
													type="text"></td>
												<td><input class="form-control" name="OFFICE_EMAIL"
													value='${dgData.OFFICE_EMAIL}' id="officeemail" type="text"></td>
											</tr>
											<tr>
												<td><input class="form-control"
													name="PERMANENT_ADDRESS"
													value='${dgData.PERMANENT_ADDRESS}' id="paddress"
													type="text"></td>
												<td><input class="form-control" name="PERMANENT_CITY"
													value='${dgData.PERMANENT_CITY}' id="pcity" type="text"></td>
												<td><input class="form-control" name="PERMANENT_PIN"
													value='${dgData.PERMANENT_PIN}' id="ppincode" type="text"></td>
												<td><input class="form-control" name="PERMANENT_STATE"
													value='${dgData.PERMANENT_STATE}' id="pstate" ="Enter the
													City" type="text"></td>
												<td><input class="form-control" name="PERMANENT_PHONE"
													value='${dgData.PERMANENT_PHONE}' id="pcontact" type="text"></td>
												<td><input class="form-control" name="pemail"
											...
											<tr>
												<td><input class="form-control"
													...
													value='${dgData.TEMPORARY_ADDRESS}' id="taddress"
													type="text"></td>
												<td><input class="form-control" name="TEMPORARY_CITY"
													value='${dgData.TEMPORARY_CITY}' id="tcity" type="text"></td>
												<td><input class="form-control" name="TEMPORARY_PIN"
													value='${dgData.TEMPORARY_PIN}' id="tpincode" type="text"></td>
												<td><input class="form-control" name="TEMPORARY_STATE"
													value='${dgData.TEMPORARY_STATE}' id="tstate" ="Enter the
													City" type="text"></td>
												<td><input class="form-control" name="TEMPORARY_PHONE"
													value='${dgData.TEMPORARY_PHONE}' id="tcontact" type="text"></td>
												<td><input class="form-control" name="TEMPORARY_EMAIL"
													value='${dgData.TEMPORARY_EMAIL}' id="temail" type="text"></td>
											</tr>
											<tr>
												<td><input class="form-control"
													name="RESIDENCE_ADDRESS"
													value='${dgData.RESIDENCE_ADDRESS}' id="raddress"
													type="text"></td>
												<td><input class="form-control" name="RESIDENCE_CITY"
													value='${dgData.RESIDENCE_CITY}' id="rcity" type="text"></td>
												<td><input class="form-control" name="RESIDENCE_PIN"
													value='${dgData.RESIDENCE_PIN}' id="rpincode" type="text"></td>
												<td><input class="form-control" name="RESIDENCE_STATE"
													value='${dgData.RESIDENCE_STATE}' id="rstate" ="Enter the
													City" type="text"></td>
												<td><input class="form-control" name="RESIDENCE_PHONE"
													value='${dgData.RESIDENCE_PHONE}' id="rcontact" ="Enter the
													City" type="text"></td>
												<td><input class="form-control" name="RESIDENCE_EMAIL"
													value='${dgData.RESIDENCE_EMAIL}' id="remail" type="text"></td>
											</tr>
											<tr>
												<td><input class="form-control" name="CKYC"
													value='${dgData.CKYCNO}' id="CKYC" type="text"></td>
												<td><input class="form-control" name="DOC"
...
<!-- Input form completed  -->	
	...
	<div id="widget-inner" class="mt-sm pd-sm" style="overflow: auto;height:570px;">
		...
		<!-- <table>
						<tr>
							<td><input type="submit" id="submit" value="Verify"
								class="btn btn-custom btn-sm btn-none mr-sm"/> <input type="submit"
								id="submit" value="No Action Required"
								class="btn btn-custom btn-sm btn-none mr-sm " /></td>
							<td></td>
						</tr>
					</table> -->
				...
				<td>
					...
					<table class="maker_table">
						<tbody>
							...
							<tr>
								<td><input class="form-control" name="OFFICE_ADDRESS"
									value='${dgData.OFFICE_ADDRESS}' id="officeaddrres" type="text"></td>
								<td><input class="form-control" name="OFFICE_CITY"
									value='${dgData.OFFICE_CITY}' id="officecity" type="text"></td>
								<td><input class="form-control" name="OFFICE_PIN"
									value='${dgData.OFFICE_PIN}' id="officepincode" type="text"></td>
								<td><input class="form-control" name="OFFICE_STATE"
									...
									City" type="text"></td>
								<td><input class="form-control" name="OFFICE_PHONE"
									value='${dgData.OFFICE_PHONE}' id="officecontact" type="text"></td>
								<td><input class="form-control" name="OFFICE_EMAIL"
									value='${dgData.OFFICE_EMAIL}' id="officeemail" type="text"></td>
							</tr>
							<tr>
								<td><input class="form-control" name="PERMANENT_ADDRESS"
									value='${dgData.PERMANENT_ADDRESS}' id="paddress" type="text"></td>
								<td><input class="form-control" name="PERMANENT_CITY"
									value='${dgData.PERMANENT_CITY}' id="pcity" type="text"></td>
								<td><input class="form-control" name="PERMANENT_PIN"
									value='${dgData.PERMANENT_PIN}' id="ppincode" type="text"></td>
							...
							<tr>
								<td><input class="form-control" name="TEMPORARY_ADDRESS"
									value='${dgData.TEMPORARY_ADDRESS}' id="taddress" type="text"></td>
								<td><input class="form-control" name="TEMPORARY_CITY"
									value='${dgData.TEMPORARY_CITY}' id="tcity" type="text"></td>
								<td><input class="form-control" name="TEMPORARY_PIN"
									value='${dgData.TEMPORARY_PIN}' id="tpincode" type="text"></td>
							...
							<tr>
								<td><input class="form-control" name="RESIDENCE_ADDRESS"
									value='${dgData.RESIDENCE_ADDRESS}' id="raddress" type="text"></td>
								<td><input class="form-control" name="RESIDENCE_CITY"
									value='${dgData.RESIDENCE_CITY}' id="rcity" type="text"></td>
								<td><input class="form-control" name="RESIDENCE_PIN"
									value='${dgData.RESIDENCE_PIN}' id="rpincode" type="text"></td>
			...
			<tr id="widget-inner" class="mt-sm pd-sm">
				<td style="width: 15%;"><input type="checkbox">Select<input type="radio">Retain</td>
				<td>
					<table class="maker_table">
						<tbody>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$("#ManualSubmitChange").css('display', 'none');
		});
