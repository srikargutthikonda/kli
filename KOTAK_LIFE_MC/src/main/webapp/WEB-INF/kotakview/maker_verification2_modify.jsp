...
<body>
						...
						<table class="maker_table">
							...
							<tr>
								<td>
											...
											<input class="form-control  pd-xs" readonly="readonly" name="GENDER_FLAG"
	...
	<div id="widget-inner" class="mt-sm pd-sm" style="overflow: auto;">
		...
		<div class="" id="datatable" style="overflow: auto;">
			<%-- <table id="example" border=2 class="dataTable" cellspacing="0" width="100%">
				<thead>
					<tr>
			...
			<table class="maker_table" id="makerTable1">
						<tr>
					...
					<table>
								<thead>			
								<tr>
									<th><label for="father_name">CLIENT_ID</label></th>
									<th><label for="city">PERMANENT_ADDRESS</label></th>
									<th><label for="pincode">PERMANENT_PHONE</label></th>
									<th><label for="father_name">MATCH_RULE</label></th>
								...
								<tr>
								<th><label for="pincode">NAME</label></th>
									<th><label for="pincode">RESIDENCE_ADDRESS</label></th>
									<th><label for="city">RESIDENCE_PHONE</label></th>
									<th><label for="address">MATCH_COUNT</label></th>
								...
								<tr>
								<th><label for="pincode">GENDER</label></th>
								<th><label for="pincode">OFFICE_ADDRESS</label></th>
									<th><label for="pincode">OFFICE_PHONE</label></th>
									<th><label for="city">MATCH_CATEGORY</label></th>
									
								</tr>
								<tr>
									<th><label for="pincode">DOB</label></th>
									<th><label for="pincode">CLIENT_TYPE</label></th>
									<th><label for="pincode">STATUS</label></th>
									<th><label for="pincode">SOURCE_SYSTEM</label></th>
								...
								<tr>
								<th><label for="pincode">AADHAAR</label></th>
									<th><label for="pincode">CRNNO</label></th>
									<th><label for="pincode">GSTIN</label></th>
									<th><label for="city">MOBILE:</label></th>
									
								</tr>
								<tr>
									<th><label for="city">CKYCNO</label></th>
								<th><label for="pincode">DOC</label></th>
		 ...
		 <c:forEach var="response" items="${responseList}"
						...
						<td>
						<table class="maker_table" id="MMM">
						<tr>
									<td>Select<input type="checkbox" name="checkbox"
									class="sub_chk" id="checkbox${theCount.count}"> Retain<input
									type="radio" class="radio" id="radio${theCount.count}"
		   ...
		   <td>${response.DOC}</td>
			...
			<td>
			 ...
			 <c:if test="${response.isRetain=='T' &&  response.SELECTED=='Y' }">
			 	<tr>
     ...
     //  alert(value.id);
         	...
         	/* 	$(function(){
         		...
         		// var id= $("#example").find("td:eq(1)").text();
         		 var id= $("#makerTable").find("td:eq(1)").text();
         		 var id2= $("#makerTable").find("td:eq(2)").text();
         		 var id3= $("#makerTable").find("td:eq(3)").text();
         		 var id4= $("#makerTable").find("td:eq(4)").text();
         		 
         		 alert("id"+id+" id2 "+id2+" id3 :"+id3+" id4: "+id4);
         		...
         		$('td:nth-child(20),th:nth-child(26)').hide(); 
